...
function AnswerRow(props) {
  return(
    <tr><AnswerData answer={props.answer}/><AnswerAction answersId={props.answer.id} voteUp = {props.voteUp} /></tr>
  );
}
...
function AnswerAction({ answersId, voteUp }) {
  return(
    <td>
      <Button variant='warning' onClick = {() => voteUp(answersId)}><i className='bi bi-arrow-up'></i></Button>
